...
pipe = pipe.to("cuda") # if you have In, you are using an Intel discrete GPU, install intel_extension_for_pytorch from(https://github.com/intel/intel-extension-for-pytorch) and instead of "cuda", use "xpu".
